  ...
  fetch(apiURL + "/yaja/", {
    ...
    .then((data) => {
      ...
      if (data.action === "retrieve") {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueMonday1)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueTuesday1)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueWednesday1)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueThursday1)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueMonday2)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueTuesday2)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueWednesday2)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueThursday2)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueMonday3)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueTuesday3)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueWednesday3)) {
        ...
        if (['외출/현체', '조퇴', '야자', '주문형강좌/방과후'].includes(valueThursday3)) {
